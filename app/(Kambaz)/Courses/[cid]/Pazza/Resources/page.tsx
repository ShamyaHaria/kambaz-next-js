...
export default function PazzaResourcesPage() {
    ...
    const handleSaveGeneralInfo = async () => {
        try {
            // TODO: Create API endpoint to save general information
    ...
    const handleSaveResource = async () => {
        try {
            // TODO: Create API endpoint to upload resource
                    ...
                    <div className={styles.resourcesGrid}>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-6">
                                ...
                                {canEdit && (
                                    <button
                                        onClick={() => openResourceModal('Homework')}
                                        className={styles.addButton}
                                    >
                                        <Plus size={18} />
                            ...
                            <div className={styles.emptyState}>
                                ...
                                <p className={styles.emptyText}>Nothing has been added to the Homework section, yet. Stay tuned!</p>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-6">
                                <h2 className={styles.sectionTitle}>Homework Solutions</h2>
                                {canEdit && (
                                    <button
                                        onClick={() => openResourceModal('Homework Solutions')}
                                        className={styles.addButton}
                                    >
                                        <Plus size={18} />
                                        <span>Add Resource</span>
                            ...
                            <div className={styles.emptyState}>
                                ...
                                <p className={styles.emptyText}>Nothing has been added to the Homework Solutions section, yet. Stay tuned!</p>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-6">
                                <h2 className={styles.sectionTitle}>Lecture Notes</h2>
                                {canEdit && (
                                    <button
                                        onClick={() => openResourceModal('Lecture Notes')}
                                        className={styles.addButton}
                                    >
                                        <Plus size={18} />
                                        <span>Add Resource</span>
                            ...
                            <div className={styles.emptyState}>
                                ...
                                <p className={styles.emptyText}>Nothing has been added to the Lecture Notes section, yet. Stay tuned!</p>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-6">
                                <h2 className={styles.sectionTitle}>General Resources</h2>
                                {canEdit && (
                                    <button
                                        onClick={() => openResourceModal('General Resources')}
                                        className={styles.addButton}
                                    >
                                        <Plus size={18} />
                                        <span>Add Resource</span>
                            ...
                            <div className={styles.emptyState}>
                                ...
                                <p className={styles.emptyText}>Nothing has been added to the General Resources section, yet. Stay tuned!</p>
                            </div>
                        </div>
                    </div>
                )}
